...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Each skill is a name plus a short description (max 85 characters). Example: Community Infrastructure with a one line explanation of what you actually do.",
  },
  {
