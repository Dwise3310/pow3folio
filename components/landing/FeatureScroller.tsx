...
const DEFAULT: FeatureCard[] = [
  ...
  },
  {
    ...
    imageAlt: "Ethereum blockchain network visualization",
  },
  {
    title: "NFT import",
    tag: "COLLECT",
    ...
    imageAlt: "Digital NFT artwork on a screen",
  },
  {
    title: "Multi-wallet",
    tag: "WALLETS",
    desc: "Connect extra wallets, name them, and let viewers switch tabs on the public onchain section.",
    image: "https://images.unsplash.com/photo-1621416894569-0f39dac31d27?auto=format&fit=crop&w=900&q=80",
    imageAlt: "Hardware wallets and multiple crypto keys",
  },
  {
