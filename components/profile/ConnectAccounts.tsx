    ...
    <div className="border-t border-border pt-5 space-y-3">
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
        <div className="rounded-lg border border-border p-3 space-y-2 min-w-0">
          ...
          {hasX && xUrl ? (
            <p className="break-all text-xs text-foreground-muted">{xUrl}</p>
          ) : (
            <p className="text-xs text-foreground-subtle">Not connected</p>
          )}
          {hasX && <p className="text-xs font-medium text-success">Connected</p>}
          <div>
            {hasX ? (
              <button
                type="button"
        ...
        <div className="rounded-lg border border-border p-3 space-y-2 min-w-0">
          ...
          {hasGitHub && githubUrl ? (
            <p className="break-all text-xs text-foreground-muted">{githubUrl}</p>
          ) : (
            <p className="text-xs text-foreground-subtle">Not connected</p>
          )}
          {hasGitHub && <p className="text-xs font-medium text-success">Connected</p>}
          <div>
            {hasGitHub ? (
              <button
                type="button"
        ...
        <div className="rounded-lg border border-border p-3 space-y-2 min-w-0">
          ...
          {hasGoogle && <p className="text-xs font-medium text-success">Connected</p>}
          <div>
            {hasGoogle ? (
              <button
                type="button"
